<div class="home-page" id="main-content" role="main">
	...
	<div class="portlet-layout row rowThree">
	...
	<div class="portlet-layout row">
		<div class="col-md-9 portlet-column portlet-column-first" id="column-7">
	...
	<div class="portlet-layout row">
		...
		<div class="col-md-4 portlet-column" id="column-10">
			$processor.processColumn("column-10", "portlet-column-content")
		</div>
		<div class="col-md-4 portlet-column portlet-column-last" id="column-11">
