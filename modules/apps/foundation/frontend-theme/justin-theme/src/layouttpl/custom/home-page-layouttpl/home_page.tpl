<div class="home-page" id="main-content" role="main">
	...
	<div class="portlet-layout row video-row">
		<div class="col-md-9 portlet-column portlet-column-first" id="column-10">
			$processor.processColumn("column-10", "portlet-column-content portlet-column-content-first")
		</div>

		<div class="col-md-3 portlet-column portlet-column-last" id="column-11">
			$processor.processColumn("column-11", "portlet-column-content portlet-column-content-last")
		</div>
	</div>

	<div class="portlet-layout row triple-row">
		...
		<div class="col-md-4 portlet-column" id="column-13">
			$processor.processColumn("column-13", "portlet-column-content")
		</div>

		<div class="col-md-4 portlet-column portlet-column-last" id="column-14">
			$processor.processColumn("column-14", "portlet-column-content portlet-column-content-last")
		</div>
	</div>

	<div class="portlet-layout row">
		<div class="col-md-12 portlet-column portlet-column-only" id="column-15">
			$processor.processColumn("column-15", "portlet-column-content portlet-column-content-only")
		</div>
	</div>

	<div class="grey-row portlet-layout row">
		<div class="col-md-12 portlet-column portlet-column-only" id="column-16">
			$processor.processColumn("column-16", "portlet-column-content portlet-column-content-only")
		</div>
	</div>
</div>